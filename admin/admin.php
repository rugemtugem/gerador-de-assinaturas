    ...
    <body class="admin-body">
        <div class="login-wrapper">
            <div class="login-card <?= $loginError ? 'shake' : '' ?>" id="loginCard">
                ...
                <?php if ($loginError): ?>
                <div style="background:rgba(231,76,60,0.1);border:1px solid rgba(231,76,60,0.3);border-radius:6px;padding:0.6rem 1rem;margin-bottom:1rem;color:#e74c3c;font-size:0.85rem;display:flex;align-items:center;gap:8px;">
        ...
        <main class="admin-main">
            ...
            <header class="admin-header">
                ...
                <div class="header-badges">
                    <?php if ($maintenance): ?>
                    <span class="status-badge" style="background:rgba(243,156,18,0.1);color:var(--warning);border:1px solid rgba(243,156,18,0.2);">
            ...
            <div class="admin-content">
                ...
                <div class="maintenance-banner">
                    <i class="bi bi-exclamation-triangle"></i> Modo manutenção ativado — o frontend principal está desabilitado.
                </div>
                <?php endif; ?>
